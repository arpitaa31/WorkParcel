...
See [docs/BROWSER-INTEGRATION.md](../docs/BROWSER-INTEGRATION.md) for protocol framing, privacy boundaries, Pack Away close safety, troubleshooting, and the manual Chrome/Edge checklist.
