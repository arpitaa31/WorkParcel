...
public sealed partial class ParcelDetailsPage : PageBase
{
    ...
    private void Build()
    {
        ...
        var body = Body(15); body.Children.Add(BuildHeader()); body.Children.Add(Ui.Rule()); body.Children.Add(BuildTools()); body.Children.Add(DropTarget()); body.Children.Add(_itemsHost); RefreshRows();
