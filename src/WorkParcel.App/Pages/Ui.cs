...
internal static class Ui
{
    ...
    public static Button Button(string label, bool primary = false) => new() { Content = Mono(label, 11, primary ? "#0B0E10" : null, true), Background = primary ? Resource("AccentBrush") : Resource("SubtleSurfaceBrush"), Foreground = primary ? Brush("#0B0E10") : Resource("PrimaryTextBrush"), BorderBrush = primary ? Resource("AccentBrush") : Resource("BorderBrush"), BorderThickness = new Thickness(1), Padding = new Thickness(11, 7, 11, 7), CornerRadius = new CornerRadius(2) };
